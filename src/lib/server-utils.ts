...
export const computeSignals = async (publicSpenderKey: string, publicViewerKey: string, amount: string) => {
    // const wasmPath = "/zk/transaction_verify.wasm";
    // const zkeyPath = "/zk/circuit_final_8inputs.zkey";

    // const wasmPath = join(process.cwd(), "public/zk/transaction_verify.wasm");
    // const zkeyPath = join(process.cwd(), "public/zk/circuit_final_8inputs.zkey");
